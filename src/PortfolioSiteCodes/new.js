...
export default function Portfolio(props) {
  ...
  React.useEffect(() => {
    //function create
    /*
    setPropid({ ...propid, number: props.idport });
    console.log("1-prorts---", props.idport);
    console.log("2-prorts---", propid.number);
    var x = propid.number;
    if (x === "") {
      alert("empty =", x.toString());
    } else {
      alert("full =", propid.number);
    }*/
    const fetchDataLink = (collection, document) => {
    ...
    const fetchDataImg = (collection, document) => {
      var x = Cookies.get("Signupusername");
    ...
    const fetchDataSkill = (collection, document) => {
      var x = Cookies.get("Signupusername");
    ...
    fetchDataImg("DeveloperDB", "Images");
    fetchDataLink("DeveloperDB", "link");
    fetchDataSkill("DeveloperDB", "skill");
  }, []);
          ...
          <section className="skills section" id="skills">
            ...
            <div className="skills__container bd-grid">
              <div>
                ...
                <Fade top>
                  <p className="skills__text">{user.profesionalDescription}</p>
                </Fade>
                <Flip bottom>
            ...
            <div className="work__container bd-grid">
              <Bounce top>
                <div className="work__img">
                  <img style={{ height: "200px" }} src={img.workImg1} alt="m" />
                </div>
              </Bounce>
              <Bounce top>
                <div className="work__img">
                  <img style={{ height: "200px" }} src={img.workImg2} alt="l" />
                </div>
              </Bounce>
              <Bounce top>
                <div className="work__img">
              ...
              <Bounce top>
                <div className="work__img">
                  <img style={{ height: "200px" }} src={img.workImg4} alt="u" />
                </div>
              </Bounce>
              <Bounce bottom>
                <div className="work__img">
